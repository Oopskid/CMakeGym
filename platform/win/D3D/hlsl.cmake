...
macro(defineShaders target type shaders)
   ...
   foreach(shader "${shaders}")
      ...
      if(NOT HLSL_${target}_OUTPUTDIRECTORY STREQUAL "")
         add_custom_command(TARGET ${target}
            COMMAND ${HLSL_SHADER_GLOBAL_COMPILER} /nologo /E main /T ${type}_${HLSL_${target}_SHADER_MODEL} $<IF:$<CONFIG:DEBUG>,/Od,/O${HLSL_SHADER_GLOBAL_OPTIMIZATION}> /Zi /Fo ${trueOutputDir}/${shaderRel}/${shaderFilename}.cso ${shader}
      ...
      if(NOT HLSL_${target}_COPYDIRECTORY STREQUAL "")
         add_custom_command(TARGET ${target}
            ...
            ARGS -E copy_if_different "${shaders}" "${trueCopyDir}/${shaderRelFile}"
            MAIN_DEPENDENCY ${shader}
